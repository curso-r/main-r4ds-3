...
bancos de dados, controle de versão, pacotes e integração contínua.
...
e inteligente de agrupar todos recursos relacionados. Por fim vamos discutir
...
localizações de forma correta. Existem duas maneiras principais de fazer isso no
R (e em qualquer outro lugar), que vamos analisar com uma metáfora: como eu
poderia pedir para você achar um documento na minha mesa do escritório?
...
a o diretório de trabalho seja transferido para outro computador. Ainda vamos
...
computador com certas propriedades especiais.
