...
por exemplo, precisam ser executadas depois que a tabela vir para o R.
...
```{r, eval = FALSE}
left_join(x, y, join_by(id == id)) # x$id casa com y$id
left_join(x, y, join_by(id)) # x$id casa com y$id
