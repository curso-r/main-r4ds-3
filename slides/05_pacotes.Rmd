...
solto. Além disso, yma função é responsável por executar uma única tarefa muito
...
através do seu atalho inúmeras vezes para garantir que ela funciona
...
- Onde a `check()` fará a grande maior parte de suas verificações
